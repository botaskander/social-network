        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a data-toggle="modal"  href="#Edit<%=p.getId()%>">
            ...
            <div class="modal fade" id="Edit<%=p.getId()%>">
                        ...
                        <div class="modal-body">
                            <form action="/editPost" method="post">
                                <div class="form-group">
                                    <label >Title:</label>
                                    <input type="text" class="form-control" name="title" value="<%=p.getTitle()%>" aria-describedby="emailHelp">
                            ...
                            <form action="/deletePost" method="post">
                                <div class="form-group" style="padding-right: 10px">
                                    ...
                                    <button type="submit" class="btn btn-danger" name="post_id" value="<%=p.getId()%>">delete</button>
                                </div>
                            </form>
